...
type Asset struct {
	...
	CreatedAt time.Time      `gorm:"type:datetime;column:created_at"` // The creation timestamp of the asset.
	LastSeen  time.Time      `gorm:"type:datetime;column:last_seen"`  // The last seen timestamp of the asset.
